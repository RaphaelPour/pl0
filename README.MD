...
Define nested procedures and call
```
CONST a=5;
VAR b;
PROCEDURE main;
...
* [x] Conditional Statement error on wrong condition. The jmpnot jumps probably to the wrong address
* [x] Call doesn't work properly. Check out BL5/BL6
